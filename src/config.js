...
export const config = {
  ...
  // Agent user id used when the PAT requester must be added to a chat before send_event.
  // For standard PAT setups this is the same identity as LIVECHAT_ACCOUNT_ID; an explicit
  // override keeps the recovery path correct for accounts where the API user id differs.
  lcRequesterUserId: process.env.LIVECHAT_REQUESTER_USER_ID || process.env.LIVECHAT_ACCOUNT_ID || '',
