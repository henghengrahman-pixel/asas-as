...
test('v1.32.1 Railway env documents optional requester user id and production UI checks runtime LiveChat health',()=>{
  ...
  assert.match(config,/LIVECHAT_REQUESTER_USER_ID \|\| process\.env\.LIVECHAT_ACCOUNT_ID/);
